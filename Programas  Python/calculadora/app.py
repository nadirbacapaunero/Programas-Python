...
Button(root, text= '0', command=lambda:get_numbers(0)).grid(row= 5, column=0, sticky=W+E)
# botones matematicos
...
Button(root, text= '-', command=lambda:get_operation('-')).grid(row= 2, column=6, sticky=W+E)
Button(root, text= '/', command=lambda:get_operation('/')).grid(row= 4, column=6, sticky=W+E)
Button(root, text= '*', command=lambda:get_operation('*')).grid(row= 3, column=6, sticky=W+E)
...
Button(root, text= 'exp', command=lambda:get_operation('**')).grid(row= 3, column=4, sticky=W+E, columnspan =2)
Button(root, text= '^2', command=lambda:get_operation('**2')).grid(row= 3, column=3, sticky=W+E)
...
Button(root, text= '.', command=lambda:get_operation('.')).grid(row= 5, column=2, sticky=W+E, columnspan= 1)
